...
== Changelog ==
	...
	* Fix: Added compatibility for Single Trips new banner layouts given in WPTE version 6.3.3.
	...
	1.2.4 - January 10th, 2025
	* New Feature: Added two new Elementor Template, namely Travel Quest and Holiday Quest.

	1.2.3 - January 1st, 2025
	* Update: Made compatible with latest WP Travel Engine plugin.
	* Fix: Resolved accessibility issues for the <a> tag.
	* New Feature: Added animation for elementor template.
	...
	* Fix: String translation issue for single trip day/hour/night text has been fixed.
	...
	1.1.9 - August 13, 2024
	* Update: Compatibility has been added for new feature of WP Travel Engine version 6.0.4 - display both days and night in the single trip.

	1.1.8 - July 30, 2024
	* Update: New dashboard has been implemented for better user experience.
	* New Featured: Added alignment, bottom offset and side offset feature for scroll to top button.
	* Fix: Breadcrumb issue in trip listing page has been fixed.

	1.1.7 - May 09, 2024
	* Fix: Warning issue in Gallery option has been fixed.
	* Update: Required UTM tags has been added in links.

	1.1.6 - April 26, 2024
	* Fix: Getting Started link issue has been fixed.
	
	1.1.5 - April 8, 2024
	* Update: Theme description has been updated.

	1.1.4 - Feb 5, 2024
	* Update: Issue with ajax requests has been fixed.

	1.1.3 - Feb 1, 2024
	* Update: Nonce check for admin notices.

	1.1.2 - Jan 24, 2024
	* Update: Corrected the new addons Pricing plans text.
